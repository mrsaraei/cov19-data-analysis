...
# Encode CT scan severity score
df_css = pd.read_csv('docs/covid_ctseverityscore_rawdata.csv')
df_css['CSS'] = df_css['CSS'].apply(encode_css)

# Concate Clinical Symptoms & Pysiological Signs Encoded Data
df = pd.concat([df_phs, df_cls, df_ehr, df_pcr, df_css], axis=1)
